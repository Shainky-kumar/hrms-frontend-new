...
export default function HomePage() {
  return (
    <div className="flex min-h-screen w-full bg-[#F7F8FA]">
      ...
      <div className="relative hidden min-h-screen w-[55%] overflow-hidden bg-[#111827] lg:flex">
        ...
        <div className="absolute left-20 bottom-1/4 h-24 w-24 rounded-full border border-white/5" />
        ...
        <div className="relative z-10 flex w-full flex-col justify-between p-14">
          ...
          <div className="max-w-xl">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <Link href="/login">
                <Button className="h-11 bg-primary hover:bg-primary/90 text-white font-medium shadow-lg shadow-primary/20 transition-all hover:shadow-primary/30 hover:-translate-y-0.5 px-8">
                  Get Started
                  <ArrowRight className="ml-2 h-4 w-4" />
                </Button>
              </Link>
              <Link href="/login">
                <Button variant="outline" className="h-11 border-white/20 text-white hover:bg-white/10 hover:text-white">
                  Log In
                </Button>
              </Link>
            </div>
      ...
      {/* RIGHT SIDE - Mobile/Alternate View */}
        ...
        <div className="relative z-10 w-full max-w-[430px]">
          <div className="bg-white rounded-2xl border border-slate-200/70 shadow-[0_8px_30px_rgb(0,0,0,0.06)] p-8 sm:p-9 space-y-7">
            ...
            <div className="space-y-4">
              <Link href="/login">
                <Button className="w-full h-11 bg-primary hover:bg-primary/90 text-white font-medium shadow-lg shadow-primary/20 transition-all hover:shadow-primary/30 hover:-translate-y-0.5">
                  Get Started
                </Button>
              </Link>
