...
export default function LoginLayout({ children }) {
  ...
  return (
    <div className="flex min-h-screen w-full bg-[#F7F8FA]">
      ...
      {/* RIGHT SIDE */}
      <div className="relative flex min-h-screen flex-1 items-center justify-center overflow-hidden px-5 py-4 sm:px-8">
        {/* Mobile Logo */}
        ...
        {/* Signup Form */}
        <div className="relative z-10 w-full max-w-[550px]">{children}</div>
      </div>
    </div>
  );
}